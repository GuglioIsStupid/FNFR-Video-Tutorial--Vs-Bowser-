...
return graphics.newSprite(
    images.icons,
	{
		...
		{x = 600, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 25: Bowser
		{x = 750, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 26: Bowser Losing
	},
	{
		...
		["bowser"] = {start = 25, stop = 25, speed = 0, offsetX = 0, offsetY = 0},
		["bowser losing"] = {start = 26, stop = 26, speed = 0, offsetX = 0, offsetY = 0},
	},
	"boyfriend",
	false
)
